...
2. Application Insights component (public ingestion for network-secured templates)
...
@description('Allow public network ingestion and query access for Application Insights and Log Analytics.')
param enablePublicMonitoringAccess bool = false
...
// Calculate if PNA to enable or disable
var monitoringPublicNetworkAccess = enablePublicMonitoringAccess ? 'Enabled' : 'Disabled'
...
resource logAnalytics 'Microsoft.OperationalInsights/workspaces@2023-09-01' = {
  ...
  properties: {
    ...
    retentionInDays: 30
    publicNetworkAccessForIngestion: monitoringPublicNetworkAccess
    publicNetworkAccessForQuery: monitoringPublicNetworkAccess
  }
}
