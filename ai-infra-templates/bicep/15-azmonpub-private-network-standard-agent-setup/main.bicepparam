...
param existingVnetResourceId = '/subscriptions/69---------------------------------03/resourceGroups/wg-swc1vnt/providers/Microsoft.Network/virtualNetworks/vnet1232swc'
param vnetName = 'vnet1232swc'
param agentSubnetName = 'default4'
...
param dnsZonesSubscriptionId = '69---------------------------------03'
...
param existingDnsZones = {
  'privatelink.services.ai.azure.com': 'wg-swc1vnt'
  'privatelink.openai.azure.com': 'wg-swc1vnt'
  'privatelink.cognitiveservices.azure.com': 'wg-swc1vnt'               
  'privatelink.search.windows.net': 'wg-swc1vnt'           
  'privatelink.blob.core.windows.net': 'wg-swc1vnt'                            
  'privatelink.documents.azure.com': 'wg-swc1vnt'                       
  'privatelink.azurecr.io': 'wg-swc1vnt'
}
...
// Keep Azure Monitor with allowed public ingestion and query; set false for complete private setup
param enablePublicMonitoringAccess = true
