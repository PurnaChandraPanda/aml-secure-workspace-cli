...
@description('When true, allow public Azure Monitor ingestion and query access and skip deployment of AMPLS/private endpoint resources. When false, disable public monitoring access and deploy AMPLS/private endpoint resources.')
...
module applicationInsights 'modules-network-secured/application-insights.bicep' = {
  ...
  params: {
    location: location
    suffix: uniqueSuffix
    enablePublicMonitoringAccess: enablePublicMonitoringAccess
...
module monitorPrivateLink 'modules-network-secured/monitor-private-link-scope.bicep' = if (!enablePublicMonitoringAccess) {
