...
variable "enable_public_monitoring_access" {
  description = "Controls network access for Application Insights and its Log Analytics workspace. If true, Enable public ingestion and query access. If false, Disable public ingestion and query access."
  type    = bool
  default = false
}
