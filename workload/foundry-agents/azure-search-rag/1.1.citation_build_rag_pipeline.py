...
skillset_name = "py-citation-rag-tutorial-ss"
datasource_name = "py-citation-rag-tutorial-ds"
...
def _create_search_index():
    ...
    fields = [
        ...
        # include source_url, source_file_name fields to store the source URL and file names of the document
        SearchField(name="source_url", type=SearchFieldDataType.String, filterable=True),
        SearchField(name="source_file_name", type=SearchFieldDataType.String, filterable=True),
...
def _create_search_skillset():
    ...
    entity_skill = EntityRecognitionSkillV3(
        ...
        selectors=[  
            SearchIndexerIndexProjectionSelector(  
                ...
                mappings=[  
                    ...
                    # metadata_storage_path is the storage path, which is closer to a URL or URL-like resource
                    InputFieldMappingEntry(name="source_url", source="/document/metadata_storage_path"), 
                    # metadata_storage_name is just a file name
...
def _create_search_indexer():
    # Create an indexer  
    indexer_name = "py-citation-rag-tutorial-idxr"
