...
- [Setup Azure Synapse on AzureML side](#setup-azure-synapse-on-azureml-side)
  ...
  - [Remote spark job submit experience](#remote-spark-job-submit-experience)
    - [ML job on managed vnet synapse with PNA disabled](#ml-job-on-managed-vnet-synapse-with-pna-disabled)
    - [ML job on managed vnet synapse with PNA enabled](#ml-job-on-managed-vnet-synapse-with-pna-enabled)
    - [ML job on no managed vnet synapse](#ml-job-on-no-managed-vnet-synapse)
    - [ML job on serverless spark synapse](#ml-job-on-serverless-spark-synapse)
