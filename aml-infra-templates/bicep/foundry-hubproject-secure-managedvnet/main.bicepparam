...
// Short name prefix used to generate resource names such as hub, project, storage, key vault, and ACR.
param prefix = 'amlsec'
...
// Resource group where the Foundry hub, project, and dependent platform resources are deployed.
param platformResourceGroupName = 'rg-pupanda7'

// Foundry hub managed network outbound mode. Use AllowOnlyApprovedOutbound for locked-down environments.
param foundryManagedNetworkIsolationMode = 'AllowOnlyApprovedOutbound'

// Storage account replication option for the hub's backing storage account.
...
param existingPrivateDnsZoneIds = {
  // Foundry hub API private endpoint zone. The hub uses the AML workspace private link group.
  ...
  // Foundry notebooks/private workspace endpoint zone.
